...
let ColorPicker = class ColorPicker extends Component {
    ...
    handlerMove(e) {
        ...
        this.setHsv(x, y);
        const dragHandler = this.getDragHandler();
        const left = parseInt(dragHandler.style.left, 10);
        const top = parseInt(dragHandler.style.top, 10);
        this.updateHsv();
        this.convertToOtherFormat();
