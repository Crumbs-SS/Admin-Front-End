...
let Tooltip = class Tooltip extends Component {
    ...
    renderArrow() {
        ...
        if (!(this.isServerRender())) {
            ...
            const tip = this.tooltipEle.querySelector('.' + ARROW_TIP);
    ...
    clear() {
        ...
        if (this.isHidden) {
            ...
            if (this.isServerRender() && this.tooltipEle) {
                ...
                // eslint-disable-next-line
                const args = { 'enableTooltip': 'false' };
                /* eslint-disable */
                this.interopAdaptor.invokeMethodAsync('OnTooltipServerCall', args);
                /* eslint-enable */
            ...
            switch (prop) {
                ...
                case 'content':
                    if (this.tooltipEle) {
                        ...
                        // eslint-disable-next-line
                        const args = { 'content': newProp.content };
                        /* eslint-disable */
                        this.interopAdaptor.invokeMethodAsync('OnTooltipServerCall', args);
                        /* eslint-enable */
                    }
    ...
    destroy() {
        ...
        if (this.isServerRender() && this.tooltipEle) {
            const placeholder = document.querySelector('#' + this.ctrlId + '_content_placeholder');
            if (placeholder) {
